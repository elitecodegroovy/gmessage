...
import (
	...
	"github.com/elitecodegroovy/gmessage/server/pse"
)
...
func (s *Server) HandleRoot(w http.ResponseWriter, r *http.Request) {
   ...
   <head>
    <link rel="shortcut icon" href="http://gio.io/img/favicon.ico">
    <style type="text/css">
  ...
  <body>
    <img src="http://gio.io/img/logo.png" alt="NATS">
    <br/>
    ...
    <br/>
    <a href=http://gio.io/documentation/server/gnatsd-monitoring/>help</a>
  </body>
</html>`)
}
